						...
						<table class="table table-hover">
						  ...
						  <tbody>
								...
								<?php
									...
									<td class="centered">
									<a href="param.php?un=<?php echo $data['username']; ?>&ps=<?php echo $data['password']; ?>&id=<?php echo $data['srno']; ?>&an=<?php echo $data['agentname']; ?>&ip=<?php echo $data['IP']; ?>&sip=<?php echo $data_server['server_ip']; ?>&sps=<?php echo $data_server['server_password']; ?>" >
									<div class="btn btn-success" style="background-color: #1abc9c;">Install</div>
									</a>
									</td>
